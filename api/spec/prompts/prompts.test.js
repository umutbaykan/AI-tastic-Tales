...
describe('matchSelectionCriteria', () => {
  it('displays Darth Vader under specific criteria', () => {
    ...
    const expectedCriteria = {
      positivePrompts: "((goes to the bank)), {{Darth Vader in full suit}}, human body, male, all black, fine detail, sharp focus, {{dystopian}}, oppressive, society, resistance, dark, sci-fi, synthwave neon retro, dramatic lighting, synthwave neon retro, {{cartoon}}, funny, whimsical, colorful, lively, vivid, digital art, smooth, sharp focus, 4k, highly detailed, smooth drawn",
      negativePrompts: "out of frame, disfigured, deformed, mutated hands, disproportioned, bad proportions, cross-eyed, low quality, blurry, female, utopia, harmony, peace, ideal, blurry, dark, grim, sinister, serious, realistic, photorealistic, unreal engine"
    };
  ...
  it('displays Hermione Granger under specific criteria', () => {
    ...
    const expectedCriteria = {
      ...
      negativePrompts: "out of frame, disfigured, deformed, mutated hands, disproportioned, bad proportions, cross-eyed, low quality, blurry, male, sunny daytime, suburbs, fantasy, magical, blurry, realistic, 3D, watercolour, low quality:1.4"
    };
